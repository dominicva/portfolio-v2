...
Each country has its own card in the UI. You can download some starter code [here]().

If you prefer to code along from scratch you can follow the instructions in the "Setting up your development
