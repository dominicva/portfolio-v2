...
We cover the TypeScript essentials that you need to start using it effectively with React. This is not a comprehensive guide and in most (surely all) cases the [TypeScript docs](https://www.typescriptlang.org/docs/)
