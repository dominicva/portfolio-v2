...
This is not a comprehensive guide, and in most (surely all) cases, the TypeScript docs provide better and more in-depth explanations.
...
Whenever possible, TypeScript gets out of our way by using **_type inference_**, inferring the type from the initial assignment.
